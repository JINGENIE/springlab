...
public class WeatherUtil {
    public static String getWeather1(String loc) throws Exception{
        ...
        urlBuilder.append("?" + URLEncoder.encode("serviceKey","UTF-8") + "=VpfwZ9%2FcD4LKICexSq5qj09IPPj5LGuh8yhzRoOrEf9qGoP3rurGvbl2uiMOVlZmR56DSrTvV3lUUgu1OwpDkg%3D%3D"); /*Service Key*/
        ...
        JSONObject jo = (JSONObject) jsonParser.parse(sb.toString()); //이렇게하면 jsonobject가 됨
    ...
    public static Object getWeather3(String loc) throws Exception{
        ...
        //결과 스트링을 제이슨 obj로 변경해서 return한다.
        return jo;
    }
}