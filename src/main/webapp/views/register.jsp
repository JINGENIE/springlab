...
<%--              <input type="text" class="form-control" id="user_address" name="user_address" placeholder="주소를 입력하세요." required>--%>
                  <input type="text" id="user_address" name="user_address"  placeholder="주소" style="width: 380px">
                  <input class ="address" type="button" onclick="sample5_execDaumPostcode()" value="주소 검색" ><br>
          ...
          <div class="form-group">
            <div class="col-lg-10 col-lg-offset-2">
              <button class= "register" type="button" id="register_btn" class="btn btn-primary">회원가입</button>
            </div>
          </div>
        </fieldset>
      </form>
